...
// chatgpt=message-circle, claude-web (claude.ai)=messages-square.
export const AgentIcon = ({ agent }: { agent: string }) =>
  ...
  : agent === "chatgpt" ? <MessageCircle size={13} strokeWidth={2.1} />
  : agent === "claude-web" ? <MessagesSquare size={13} strokeWidth={2.1} />
